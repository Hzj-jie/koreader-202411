describe("KeepAlive plugin tests", function()
  ...
  it("supports Cervantes and toggles pause_auto_suspend", function()
    ...
    assert
      ...
      .was_called_with(mock_ui.menu, keepalive)
  ...
  it("supports Kindle and calls LIPC preventScreenSaver", function()
    ...
    assert
      .spy(mock_handle.set_int_property)
      .was_called_with(mock_handle, "com.lab126.powerd", "preventScreenSaver", 1)
    ...
    assert
      .spy(mock_handle.set_int_property)
      .was_called_with(mock_handle, "com.lab126.powerd", "preventScreenSaver", 0)
    assert.is_false(PluginShare.keepalive)
  ...
  it("supports SDL and shows InfoMessage", function()
    ...
    assert.are.equal(
      "This is a dummy implementation of 'enable' function.",
      info_msg.text
    )
    ...
    assert.are.equal(
      "This is a dummy implementation of 'disable' function.",
      disable_msg.text
    )
  end)
