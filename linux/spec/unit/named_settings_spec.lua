describe("named_settings", function()
  ...
  setup(function()
    ...
    Device.hasEinkScreen = function()
      return mock_has_eink
    end
    Device.isTouchDevice = function()
      return mock_is_touch
    end
    Util.backup_dir = function()
      return "/mock/backup/dir"
    end
  end)
  ...
  describe("directory settings", function()
    it(
      "should return home_dir setting if present, or fallback to backup_dir",
      function()
    ...
    it(
      "should return lastdir setting if present, or fallback to backup_dir",
      function()
  ...
  describe("standard accessors", function()
    ...
    it(
      "should return default or saved value for auto_standby_timeout_seconds",
      function()
    ...
    it(
      "should return default or saved value for back_in_filemanager",
      function()
    ...
    it(
      "should return default or saved value for document_metadata_folder",
      function()
  ...
  describe("E-Ink / refresh rate logic", function()
    ...
    it(
      "should return full rate value or default based on low_pan_rate",
      function()
        mock_has_eink = false
    ...
    it(
      "should return scroll rate value or default based on low_pan_rate",
      function()
        mock_has_eink = false
