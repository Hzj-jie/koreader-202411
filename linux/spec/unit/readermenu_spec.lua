describe("ReaderMenu integration", function()
  ...
  it(
    "should trigger TouchMenu when tapping the top part of the screen",
    function()
      ...
      print(
        "UIManager._input_gestures_disabled:",
        UIManager._input_gestures_disabled
      )
  ...
  it(
    "should trigger TouchMenu when swiping down from the top part of the screen",
    function()
      local sample_pdf = "spec/front/unit/data/2col.pdf"
      purgeDir(DocSettings:getSidecarDir(sample_pdf))
      os.remove(DocSettings:getHistoryPath(sample_pdf))
  ...
  it(
    "should not spawn a new TouchMenu layer when swiping south on top-level TouchMenu",
    function()
      local sample_pdf = "spec/front/unit/data/2col.pdf"
      purgeDir(DocSettings:getSidecarDir(sample_pdf))
      os.remove(DocSettings:getHistoryPath(sample_pdf))
      ...
      G_named_settings.activate_menu = function()
        return "swipe"
      end
  ...
  it(
    "should not leak menu when panning south on top while menu is open",
    function()
      local Event = require("ui/event")
      local sample_pdf = "spec/front/unit/data/2col.pdf"
      purgeDir(DocSettings:getSidecarDir(sample_pdf))
  ...
  it(
    "should not trigger TouchMenu assertion under normal conditions",
    function()
      local sample_pdf = "spec/front/unit/data/2col.pdf"
      local readerui = ReaderUI:new({
        dimen = Screen:getSize(),
  ...
  it(
    "should trigger TouchMenu assertion when showing multiple instances",
    function()
      local sample_pdf = "spec/front/unit/data/2col.pdf"
      local readerui = ReaderUI:new({
        dimen = Screen:getSize(),
  ...
  it("should compute tab index from touch position correctly", function()
  ...
  it("should handle menu search, press menu, and dimensions updates", function()
    local readerui = createReaderUI()
    local menu = readerui.menu
