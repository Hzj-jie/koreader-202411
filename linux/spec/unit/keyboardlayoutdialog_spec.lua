...
describe("KeyboardLayoutDialog UI component", function()
  ...
  it(
    "should instantiate without crashing when parent and keyboard state are mocked",
    function()
      local mock_keyboard = {
  ...
  it(
    "should initialize, run callbacks with self, and clear parent ref on close",
    function()
      local mock_keyboard = {
        getKeyboardLayout = function()
          return "en_US"
      ...
      assert
        .spy(mock_keyboard.setKeyboardLayout)
        .was_called_with(mock_keyboard, "fr_FR")
  ...
  it(
    "should instantiate with only one language layout in lang_to_keyboard_layout",
    function()
      local mock_keyboard = {
        lang_to_keyboard_layout = {
          en_US = {},
  ...
  it(
    "should throw error when lang_to_keyboard_layout is invalid (not a table)",
    function()
      local mock_keyboard = {
