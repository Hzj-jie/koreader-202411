describe("FileExtAssoc element", function()
  ...
  it("should enable and disable all supported extension associations", function()
  ...
  it("should generate settings menu table for file extension associations", function()
