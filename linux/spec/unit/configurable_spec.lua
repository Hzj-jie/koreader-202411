describe("Configurable", function()
  ...
  describe("loadDefaults", function()
    ...
    it(
      "should load defaults from config_options when G_reader_settings does not have them",
      function()
        local original_has = G_reader_settings.has
        G_reader_settings.has = function()
          return false
        end
  ...
  describe("load", function()
    it(
      "should load settings from provided settings object with prefix",
      function()
    ...
    it("should assert if loaded value is nil", function()
      local mock_settings = {
        ...
        read = function()
          return nil
        end, -- returns nil even if has is true
      }
  ...
  describe("save", function()
    it(
      "should save settings to provided settings object with prefix and defaults",
      function()
        local saved_data = {}
        local mock_settings = {
