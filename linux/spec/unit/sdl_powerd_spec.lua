...
describe("SDL PowerD", function()
  ...
  describe("setIntensityHW", function()
    it("should update hw_intensity and log the change", function()
      ...
      assert
        .spy(require("logger").info).was
        .called_with("set brightness to", 75)
    end)
  ...
  describe("getCapacityHW", function()
    it(
      "should return battery percent when SDL returns a valid capacity",
      function()
  ...
  describe("isChargingHW", function()
    ...
    it(
      "should return false if SDL getPowerInfo call does not succeed",
      function()
        mock_SDL.getPowerInfo = spy.new(function()
  ...
  describe("suspend and resume lifecycle", function()
    ...
    it(
      "should call device:_afterResume and invalidate capacity cache on afterResume",
      function()
