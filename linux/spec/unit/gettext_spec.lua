...
describe("GetText module", function()
    ...
    describe("changeLang", function()
        ...
        it("should return nil when passing newlang = POSIX", function()
            assert.is_nil(GetText.changeLang("POSIX"))
        end)
        it("should return nil when passing newlang = en", function()
            assert.is_nil(GetText.changeLang("en"))
        end)
