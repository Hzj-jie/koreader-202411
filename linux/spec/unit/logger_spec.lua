...
describe("logger", function()
  ...
  describe("setLevel", function()
    ...
    it("disables lower priority levels and enables higher ones", function()
      ...
      assert.is_nil(capture_log(function()
      ...
      assert.is_not_nil(capture_log(function()
  ...
  describe("output formatting", function()
    ...
    it("formats debug logs correctly", function()
      local out = capture_log(function()
        logger.dbg("hello")
      end)
    ...
    it("serializes tables using serpent", function()
      ...
      local expected_out = "05/18/26-21:22:39 INFO  "
        .. expected_tbl_str
        .. " \n"
