describe("CommonMenu apps helper", function()
  ...
  describe("exitOrRestart", function()
    ...
    it(
      "should perform restart cleanly when startup script is up to date",
      function()
        local before_exit_called = false
        local on_exit_called = false
    ...
    it(
      "should show confirmation box when startup script is outdated and not forced",
      function()
        local before_exit_called = false
        local on_exit_called = false
        local after_exit_called = false
        ...
        assert.are.equal(
          "Restart anyway",
          mock_confirm_box_instance.args.ok_text
        )
