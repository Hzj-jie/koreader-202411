describe("LuaDefaults", function()
  ...
  describe("initialization and defaults", function()
    it(
      "should correctly open defaults file and load defaults.lua as read-only",
      function()
  ...
  describe("reading settings", function()
    ...
    it(
      "should write parameter default to rw table if not customized and return it",
      function()
        local defaults = LuaDefaults:open(TEST_FILE)
  ...
  describe("saving and deleting", function()
    ...
    it(
      "should optimize out customization if it matches the default ro value",
      function()
        local defaults = LuaDefaults:open(TEST_FILE)
        defaults:save("DHINTCOUNT", 10)
        assert.is_true(defaults:hasBeenCustomized("DHINTCOUNT"))
    ...
    it(
      "should delete key from rw table and return back to ro default",
      function()
        local defaults = LuaDefaults:open(TEST_FILE)
        defaults:save("DHINTCOUNT", 10)
        assert.is_true(defaults:hasBeenCustomized("DHINTCOUNT"))
  ...
  describe("boolean helpers", function()
    it(
      "should check true/false correctly with customization fallback",
      function()
        local defaults = LuaDefaults:open(TEST_FILE)
  ...
  describe("disk flushing", function()
    it(
      "should write customizations to file on flush and load them back",
      function()
        local defaults = LuaDefaults:open(TEST_FILE)
