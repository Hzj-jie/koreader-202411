describe("AutoStandby plugin tests", function()
  ...
  it("should schedule standby allow after min delay on input event", function()
    ...
    assert
      .stub(UIManager.scheduleIn)
      .was_called_with(UIManager, 1, class.allow, class)
  end)

  it(
    "should adaptively scale delay and reset it based on input frequencies",
    function()
      ...
      assert
        .stub(UIManager.scheduleIn)
        .was_called_with(UIManager, 6, class.allow, class)
  ...
  it(
    "should trigger aggressive standby when battery drops below threshold",
    function()
