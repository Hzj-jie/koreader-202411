...
describe("socketutil", function()
  ...
  describe("UserAgent Monkey-patching", function()
    it("correctly constructs and patches UserAgent", function()
      local expected_ua =
        "KOReader/v2026.05 (https://koreader.rocks/) LuaSocket/3.0-rc1"
  ...
  describe("TCP Socket Wrapping (socket.tcp)", function()
    ...
    it(
      "calls settimeout on created sockets with configured timeouts",
      function()
  ...
  describe("Sinks", function()
    describe("table_sink", function()
      ...
      it(
        "behaves like a standard ltn12 table sink if total_timeout < 0",
        function()
      ...
      it(
        "behaves normally if total_timeout is positive and not expired",
        function()
      ...
      it(
        "returns nil and timeout error code if total_timeout expires",
        function()
    ...
    describe("file_sink", function()
      ...
      it(
        "behaves like a standard ltn12 file sink if total_timeout < 0",
        function()
          socketutil:reset_timeout() -- total_timeout = -1
      ...
      it(
        "returns nil and timeout error and closes handle if total_timeout expires",
        function()
          socketutil:set_timeout(5, 10) -- total_timeout = 10
      ...
      it(
        "returns nil and error if handle is missing and total_timeout is active",
        function()
          socketutil:set_timeout(5, 10) -- total_timeout = 10
