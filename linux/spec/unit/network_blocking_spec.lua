...
describe("NetworkMgr non-blocking test", function()
  ...
  setup(function()
    ...
    Device.hasWifiManager = function()
      return true
    end
    ...
    UIManager.close = function(self) end
  end)

  it(
    "should NOT loop/block when disconnected and waiting for wpa_supplicant",
    function()
  ...
  it(
    "should show settings menu and return nil if no connected or preferred network",
    function()
      package.loaded["ui/network/manager"] = nil
      local NetworkMgr = require("ui/network/manager")
      NetworkMgr.getNetworkList = function()
