describe("MenuSorter module", function()
  ...
  it(
    "should handle invalid sorting_hint gracefully without crashing",
    function()
      local menu_items = {
        ["KOMenu:menu_buttons"] = {},
  ...
  it(
    "should merge single-item submenus into parent with merged text",
    function()
      local menu_items = {
        ["KOMenu:menu_buttons"] = {},
        tools = { text = "Tools" },
  ...
  describe("mergeAndSort", function()
    ...
    it(
      "should successfully load user overrides even if settings path contains dots (like ~/.config/koreader)",
      function()
        local DataStorage = require("datastorage")
        local lfs = require("libs/libkoreader-lfs")
