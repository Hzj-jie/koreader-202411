...
describe("device/generic/powerd", function()
  ...
  describe("initialization", function()
    ...
    it(
      "loads default hardware states when frontlight and natural light are present",
      function()
        local p = BasePowerD:new({
          ...
          fl_warmth_max = 15,
          device = mock_device,
          frontlightIntensityHW = function()
            return 12
          end,
          frontlightWarmthHW = function()
            return 6
          end,
  ...
  describe("frontlight status and toggling", function()
    ...
    it("turns off the frontlight", function()
      ...
      assert.are.equal(
        ...
        mock_uimgr.broadcastEvent.calls[1].vals[2].name
      )
    end)
  ...
  describe("intensity and warmth setting", function()
    ...
    it(
      "sets warmth converting KOReader [0..100] to hardware native scale [0..15]",
      function()
  ...
  describe("battery status and capacity caching", function()
    ...
    it(
      "retrieves capacity using monotonic time if UIManager is not ready",
      function()
  ...
  describe("suspend and resume lifecycle", function()
    it(
      "triggers device hooks and invalidates caches on suspend/resume",
      function()
        powerd:UIManagerReady(mock_uimgr)
  ...
  describe("getBatterySymbol", function()
    it(
      "returns correct battery icon corresponding to capacities and charging state",
      function()
        -- Charged state
