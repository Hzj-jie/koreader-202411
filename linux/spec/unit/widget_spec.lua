  ...
  describe("showWidget", function()
    it("registers the child and shows it via UIManager", function()
      ...
      assert
        ...
        .was_called_with(mock_uimanager, child, "arg1", "arg2")
    end)
  end)

  describe("uimanagedCleanUp", function()
    it(
      "closes all shown children and nils their named fields in parent",
      function()
        ...
        assert
          .spy(mock_uimanager.closeIfShown)
          .was_called_with(mock_uimanager, child1)
        assert
          .spy(mock_uimanager.closeIfShown)
          .was_called_with(mock_uimanager, child2)
        assert
          .spy(mock_uimanager.closeIfShown)
          .was_called_with(mock_uimanager, child3)
    ...
    it("does not nil the array portion (numeric keys) of the parent", function()
      ...
      assert
        .spy(mock_uimanager.closeIfShown)
        .was_called_with(mock_uimanager, child)
