describe("sort", function()
  ...
  describe("natsort_cmp", function()
    ...
    it(
      "should sort numbers naturally (numerically, not alphabetically)",
      function()
        local cmp = sort.natsort_cmp()
        local t = { "10", "2", "1", "20" }
        table.sort(t, cmp)
    ...
    it(
      "should sort version-like strings correctly (treating dot-numbers as decimals)",
      function()
        local cmp = sort.natsort_cmp()
    ...
    it("should handle leading zeros in numerical sorting", function()
      ...
      table.sort(t, cmp)
      assert.are.same(
        { "file01.txt", "file1.txt", "file02.txt", "file2.txt" },
        t
      )
    end)
    ...
    describe("caching", function()
      ...
      it(
        "should reuse cache values to avoid re-evaluation (proven by injection)",
        function()
          local my_cache = {
