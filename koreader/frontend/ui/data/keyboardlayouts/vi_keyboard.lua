...
local vi_keyboard = require("util").copyRequire("ui/data/keyboardlayouts/en_keyboard")
...
local wrapInputBox = function(inputbox)
  if inputbox._vi_wrapped == nil then
    ...
    table.insert(wrappers, util.wrapMethod(inputbox, "closeKeyboard", nil, separate))
