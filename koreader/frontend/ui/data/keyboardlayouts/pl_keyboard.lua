...
keys[2][3][1].east, keys[2][3][1].south =
  keys[2][3][1].south, keys[2][3][1].east
keys[2][3][2].east, keys[2][3][2].south =
  keys[2][3][2].south, keys[2][3][2].east

-- keys[2][9][1].east = 'Ó'; keys[1][9][1].northeast = 'Ô'
-- keys[2][9][2].east = 'ó'; keys[1][9][2].northeast = 'ô'
keys[2][9][1].east, keys[2][9][1].south =
  keys[2][9][1].south, keys[2][9][1].east
keys[2][9][2].east, keys[2][9][2].south =
  keys[2][9][2].south, keys[2][9][2].east

-- keys[3][1][1].east = 'Ą'; keys[2][1][1].south = 'Â'
-- keys[3][1][2].east = 'ą'; keys[2][1][2].south = 'â'
keys[3][1][1].east, keys[3][1][1].south =
  keys[3][1][1].south, keys[3][1][1].east
keys[3][1][2].east, keys[3][1][2].south =
  keys[3][1][2].south, keys[3][1][2].east

-- keys[3][2][1].east = 'Ś'; keys[2][2][1].northeast = 'Ŝ'
-- keys[3][2][2].east = 'ś'; keys[2][2][2].northeast = 'ŝ'
keys[3][2][1].east, keys[3][2][1].northeast =
  keys[3][2][1].northeast, keys[3][2][1].east
keys[3][2][2].east, keys[3][2][2].northeast =
  keys[3][2][2].northeast, keys[3][2][2].east
...
keys[4][2][1].west, keys[4][2][1].southwest =
  keys[4][2][1].southwest, keys[4][2][1].west
keys[4][2][2].west, keys[4][2][2].southwest =
  keys[4][2][2].southwest, keys[4][2][2].west
...
keys[4][4][1].east, keys[4][4][1].northeast =
  keys[4][4][1].northeast, keys[4][4][1].east
keys[4][4][2].east, keys[4][4][2].northeast =
  keys[4][4][2].northeast, keys[4][4][2].east

-- keys[4][7][1].east = 'Ń'; keys[3][7][1].northeast = 'ɲ'
-- keys[4][7][2].east = 'ń'; keys[3][7][2].northeast = 'ɲ'
keys[4][7][1].east, keys[4][7][1].northeast =
  keys[4][7][1].northeast, keys[4][7][1].east
keys[4][7][2].east, keys[4][7][2].northeast =
  keys[4][7][2].northeast, keys[4][7][2].east
