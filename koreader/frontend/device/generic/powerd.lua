...
function BasePowerD:getAuxCapacityHW()
  return 0
end
...
function BasePowerD:isChargedHW()
  return false
end
function BasePowerD:isAuxChargingHW()
  return false
end
function BasePowerD:isAuxChargedHW()
  return false
end
function BasePowerD:frontlightIntensityHW()
  return 0
end
function BasePowerD:isFrontlightOnHW()
...
function BasePowerD:frontlightWarmthHW()
  return 0
end
...
function BasePowerD:setWarmth(warmth, force_setting)
  ...
  if not force_setting and warmth == self:frontlightWarmth() then
    return false
  end
...
function BasePowerD:getCapacity()
  ...
  if UIManager then
    ...
    now = time.monotonic() + self.device.total_standby_time + self.device.total_suspend_time
  end
