...
function DeviceListener:onSwapPageTurnButtons(side)
  ...
  elseif side == "right" then
    ...
    if
      ...
      and G_reader_settings:isTrue("input_invert_right_page_turn_keys")
    then
...
function DeviceListener:onRestart()
  self.ui.menu:exitOrRestart(function()
...
function DeviceListener:onFullRefresh()
  if self.ui and self.ui.view then
    UIManager:broadcastEvent(Event:new("UpdateFooter", self.ui.view.footer_visible))
  end
