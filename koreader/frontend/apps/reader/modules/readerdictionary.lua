...
function ReaderDictionary:showDownload(downloadable_dicts)
  ...
  for __, dict in ipairs(downloadable_dicts) do
    ...
    table.insert(
      kv_pairs,
      { "  " .. gettext("Entries"), dict.entries, separator = true }
    )
  end
...
function ReaderDictionary:onClose()
  UIManager:closeIfNotNil(self.dict_window)
  self.dict_window = nil
  UIManager:closeIfNotNil(self.dictionary_lookup_dialog)
  self.dictionary_lookup_dialog = nil
  UIManager:closeIfNotNil(self.download_window)
