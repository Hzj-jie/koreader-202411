...
function ReaderScrolling:getDefaultScrollActivationDelay_ms()
  if
    (self.ui.gestures and self.ui.gestures.multiswipes_enabled)
    or G_named_settings.activate_menu() ~= "tap"
  then
...
function ReaderScrolling:addToMainMenu(menu_items)
  menu_items.scrolling = {
    ...
    enabled_func = function()
      ...
      if
        self.ui.view
        and (self.ui.view.page_scroll or self.ui.view.view_mode == "scroll")
      then
        return true
      end
      return false
