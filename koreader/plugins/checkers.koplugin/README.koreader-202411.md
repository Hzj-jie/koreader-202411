# Checkers Compatibility for KOReader v2024.11

This folder contains the compatibility record and integration details for the `Checkers` plugin, which was imported from upstream `koreader/contrib` to run on KOReader v2024.11.
