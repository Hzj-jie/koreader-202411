describe("Clock plugin tests", function()
  ...
  it(
    "initializes with keys and touch gestures, and registers to main menu",
    function()
      ...
      assert
        ...
        .was_called_with(mock_ui.menu, Clock)
  ...
  it("handles show and scheduling timeout if configured", function()
    ...
    assert
      .stub(UIManager.scheduleIn)
      .was_called_with(match.ref(UIManager), 10, match.is_function())
  ...
  it("handles close and sets UI dirty", function()
    ...
    assert
      .stub(UIManager.setDirty)
      .was_called_with(match.ref(UIManager), nil, match.is_function())
  ...
  it("registers action with Dispatcher on init/register", function()
    ...
    assert
      .stub(Dispatcher.registerAction)
      .was_called_with(match.ref(Dispatcher), "clock_show", match.is_table())
