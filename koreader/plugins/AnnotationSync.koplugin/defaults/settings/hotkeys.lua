...
return {
  hotkeys_fm = {
    ...
    modifier_plus_home = Device:hasWifiToggle() and { toggle_wifi = true }
      or {},
  ...
  hotkeys_reader = {
    ...
    modifier_plus_left_page_back = not Device:isTouchDevice() and {
      select_prev_page_link = true,
    } or {},
    modifier_plus_left_page_forward = not Device:isTouchDevice() and {
      select_next_page_link = true,
    } or {},
    modifier_plus_right_page_back = not Device:isTouchDevice() and {
      select_prev_page_link = true,
    } or {},
    modifier_plus_right_page_forward = not Device:isTouchDevice() and {
      select_next_page_link = true,
    } or {},
    modifier_plus_back = { open_previous_document = true },
    modifier_plus_home = Device:hasWifiToggle() and { toggle_wifi = true }
