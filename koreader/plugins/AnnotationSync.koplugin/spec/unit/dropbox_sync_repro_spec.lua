describe("Dropbox Sync Reproduction", function()
  ...
  setup(function()
    ...
    G_reader_settings:save("cloud_download_dir", "http://mock-dropbox")
    G_reader_settings:save(
      "cloud_server_object",
      json.encode({ url = "http://mock-dropbox", type = "dropbox" })
    )
  ...
  it(
    ...
    function()
      ...
      assert.is_true(
        success,
        "Sync should now succeed by treating Dropbox path/not_found as empty state"
      )
