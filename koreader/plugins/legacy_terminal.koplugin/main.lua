-- This is a legacy version of terminal before vt52 implementation for legacy
-- devices, i.e. DXG. vt52 implementation doesn't work on DXG.
-- Downloaded from
-- https://github.com/koreader/koreader/blob/859327dea58cfa2b3c634b5ae4ecc1008b8c6f23/plugins/terminal.koplugin/main.lua
-- with local changes to make it compatible with koreader-202411.
...
function Terminal:init()
  ...
  self.items_per_page = G_reader_settings:read("items_per_page") or 16
  self.shortcuts = self.settings:readTableRef("shortcuts", {})
end
