...
function Game.getMinSize()
  return MIN_SIZE
end
function Game.getMaxSize()
  return MAX_SIZE
end
  ...
  for r = 1, n do
    for c = 1, n do
      if r == n and c == n then
        ...
        if self.grid[r][c] ~= expected then
          return false
        end
        expected = expected + 1
      end
...
function Game:getEmpty()
  return self.empty_r, self.empty_c
end
function Game:isWon()
  return self.won
end
function Game:hasStarted()
  return self.started
end
