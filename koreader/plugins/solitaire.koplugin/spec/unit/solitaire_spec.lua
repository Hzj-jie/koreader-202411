describe("Solitaire game engine unit tests", function()
  ...
  it("should check tableau placement rules (alternating color, decreasing rank)", function()
    local g = Game:new()
  ...
  it("should check foundation placement rules (same suit, increasing rank starting with Ace)", function()
    local g = Game:new()
