...
return {
  ...
  {
    q = "All happy families are alike; each unhappy family is unhappy in its own way.",
    a = "Leo Tolstoy",
    b = "Anna Karenina",
  },
  {
  ...
  {
    q = "Even the darkest night will end and the sun will rise.",
    a = "Victor Hugo",
    b = "Les Misérables",
  },
  ...
  {
    q = "When you want something, all the universe conspires in helping you to achieve it.",
    a = "Paulo Coelho",
    b = "The Alchemist",
  },
  {
  ...
  {
    q = "I am not afraid of storms, for I am learning how to sail my ship.",
    a = "Louisa May Alcott",
    b = "Little Women",
  },
  {
    q = "The only way out of the labyrinth of suffering is to forgive.",
    a = "John Green",
    b = "Looking for Alaska",
  },
  {
    q = "Some infinities are bigger than other infinities.",
    a = "John Green",
    b = "The Fault in Our Stars",
  },
  {
    q = "The more that you read, the more things you will know. The more that you learn, the more places you'll go.",
    a = "Dr. Seuss",
    b = "I Can Read With My Eyes Shut!",
  },
  {
    q = "Fantasy is hardly an escape from reality. It's a way of understanding it.",
    a = "Lloyd Alexander",
  },
  {
  ...
  {
    q = "It's only after we've lost everything that we're free to do anything.",
    a = "Chuck Palahniuk",
    b = "Fight Club",
  },
  {
  ...
  {
    q = "Words are, in my not-so-humble opinion, our most inexhaustible source of magic.",
    a = "J.K. Rowling",
  },
  {
  ...
  {
    q = "Whatever our souls are made of, his and mine are the same.",
    a = "Emily Brontë",
    b = "Wuthering Heights",
  },
  {
    q = "I took a deep breath and listened to the old brag of my heart: I am, I am, I am.",
    a = "Sylvia Plath",
    b = "The Bell Jar",
  },
  ...
  {
    q = "There's always another secret.",
    a = "Brandon Sanderson",
  ...
  {
    q = "The man who does not read has no advantage over the man who cannot read.",
    a = "Mark Twain",
  },
  {
    q = "One must always be careful of books, and what is inside them, for words have the power to change us.",
    a = "Cassandra Clare",
    b = "City of Bones",
  },
  {
  ...
  {
    q = "We must not allow other people's limited perceptions to define us.",
    a = "Virginia Satir",
  },
  {
  ...
  {
    q = "Imperfection is beauty, madness is genius and it's better to be absolutely ridiculous than absolutely boring.",
    a = "Marilyn Monroe",
  },
  {
  ...
  {
    q = "Books are mirrors: we only see in them what we already have inside us.",
    a = "Carlos Ruiz Zafón",
  ...
  {
    q = "Until I feared I would lose it, I never loved to read. One does not love breathing.",
    a = "Harper Lee",
    b = "To Kill a Mockingbird",
  },
  {
    q = "I declare after all there is no enjoyment like reading!",
    a = "Jane Austen",
    b = "Pride and Prejudice",
  },
  {
    q = "Reading is essential for those who seek to rise above the ordinary.",
    a = "Jim Rohn",
  },
  ...
  {
    q = "I would be most content if my children grew up to be the kind of people who think decorating consists mostly of building enough bookshelves.",
    a = "Anna Quindlen",
  },
  {
    q = "Outside of a dog, a book is a man's best friend. Inside of a dog it's too dark to read.",
    a = "Groucho Marx",
  },
  {
  ...
  {
    q = "Reading is a conversation. All books talk. But a good book listens as well.",
    a = "Mark Haddon",
  },
  { q = "Writing is the painting of the voice.", a = "Voltaire" },
  {
    q = "A writer only begins a book. A reader finishes it.",
    a = "Samuel Johnson",
  },
  {
  ...
  {
    q = "I have waited for this opportunity for more than half a century, to repeat to you once again my vow of eternal fidelity and everlasting love.",
    a = "Gabriel García Márquez",
    b = "Love in the Time of Cholera",
  },
  {
    q = "I love you without knowing how, or when, or from where. I love you simply, without problems or pride.",
    a = "Pablo Neruda",
  },
  {
    q = "The best love is the kind that awakens the soul and makes us reach for more.",
    a = "Nicholas Sparks",
    b = "The Notebook",
  },
  { q = "You had me at hello.", a = "Cameron Crowe", b = "Jerry Maguire" },
  {
    q = "To love at all is to be vulnerable.",
    a = "C.S. Lewis",
    b = "The Four Loves",
  },
  {
    q = "The greatest thing you'll ever learn is just to love, and be loved in return.",
    a = "eden ahbez",
  },
  { q = "Where there is love there is life.", a = "Mahatma Gandhi" },
  {
    q = "I am who I am because of you. You are every reason, every hope, and every dream I've ever had.",
    a = "Nicholas Sparks",
    b = "The Notebook",
  },
  {
    q = "There is only one happiness in this life, to love and be loved.",
    a = "George Sand",
  },
  ...
  {
    q = "Life is not measured by the number of breaths we take, but by the moments that take our breath away.",
    a = "Maya Angelou",
  },
