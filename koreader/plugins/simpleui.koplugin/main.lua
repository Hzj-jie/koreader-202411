...
local function patchSettings(tbl)
  if tbl and not tbl.readSetting then
    tbl.readSetting = tbl.read
    tbl.saveSetting = tbl.save
    tbl.delSetting = tbl.delete
  end
end
patchSettings(LuaSettings)
if G_reader_settings then
  patchSettings(getmetatable(G_reader_settings))
end
if G_defaults then
  patchSettings(getmetatable(G_defaults))
end
  ...
  local ok, err = pcall(function()
    ...
    do
      ...
      if ok_ds and ok_lfs then
        ...
        for _, sub in ipairs({
          ...
          "/sui_wallpapers",
          "/sui_presets",
          "/sui_presets/sui_presets_export",
          "/sui_presets/sui_presets_import",
        }) do
          local path = base .. sub
    ...
    if not G_reader_settings:isTrue("simpleui_userdata_migrated_v1") then
      pcall(function()
        ...
        if not (ok_ds and ok_lfs and ok_ffi) then
          return
        end
        ...
        if plugin_root then
          ...
          local function copyDirContents(src, dst)
            ...
            for fname in lfs.dir(src) do
              if fname ~= "." and fname ~= ".." then
                ...
                if
                  lfs.attributes(src_f, "mode") == "file"
                  and lfs.attributes(dst_f, "mode") ~= "file"
                then
          ...
          -- then remove the now-redundant in-plugin directory.
          copyDirContents(
            plugin_root .. "/desktop_modules/custom_quotes",
            data_dir .. "/sui_quotes"
          )
        ...
        local key_renames = {
          ...
          {
            "quote_deck_order",
            "simpleui_quote_deck_order",
          },
          {
            "quote_deck_pos",
            "simpleui_quote_deck_pos",
          },
          {
            "quote_deck_count",
            "simpleui_quote_deck_count",
          },
          {
            "quote_hl_deck_order",
            "simpleui_quote_hl_deck_order",
          },
          {
            "quote_hl_deck_pos",
            "simpleui_quote_hl_deck_pos",
          },
          {
            "quote_hl_deck_count",
            "simpleui_quote_hl_deck_count",
          },
          {
            "quote_custom_deck_order",
            "simpleui_quote_custom_deck_order",
          },
          {
            "quote_custom_deck_pos",
            "simpleui_quote_custom_deck_pos",
          },
          {
            "quote_custom_deck_count",
            "simpleui_quote_custom_deck_count",
          },
          {
            "quote_custom_deck_file",
            "simpleui_quote_custom_deck_file",
          },
          -- quote_source and quote_custom_file are per-instance (prefixed
          -- with navbar_homescreen_ at runtime); migrate all known slots.
          {
            "navbar_homescreen_quote_source",
            "navbar_homescreen_simpleui_quote_source",
          },
          {
            "navbar_homescreen_quote_custom_file",
            "navbar_homescreen_simpleui_quote_custom_file",
          },
        }
    ...
    if not SUISettings:isTrue("simpleui_settings_migrated_v2") then
      pcall(function()
        ...
        SUISettings:flush()
        logger.info(
          "simpleui: settings migration v2 complete —",
          migrated,
          "keys moved to SUISettings"
        )
      end)
    ...
    if not SUISettings:isTrue("simpleui_settings_migrated_v3") then
      pcall(function()
        ...
        local fixed_renames = {
          ...
          {
            "navbar_bar_size_pct",
            "simpleui_bar_size_pct",
          },
          {
            "navbar_hide_separator",
            "simpleui_bar_hide_separator",
          },
          {
            "navbar_bottom_margin_pct",
            "simpleui_bar_bottom_margin_pct",
          },
          {
            "navbar_icon_scale_pct",
            "simpleui_bar_icon_scale_pct",
          },
          {
            "navbar_label_scale_pct",
            "simpleui_bar_label_scale_pct",
          },
          {
            "navbar_rs_text_scale_pct",
            "simpleui_bar_rs_text_scale_pct",
          },
          -- Bottom bar — pagination / pager
          {
            "navbar_pagination_visible",
            "simpleui_bar_pagination_visible",
          },
          {
            "navbar_pagination_size",
            "simpleui_bar_pagination_size",
          },
          {
            "navbar_pagination_show_subtitle",
            "simpleui_bar_pagination_show_subtitle",
          },
          {
            "navbar_navpager_enabled",
            "simpleui_bar_navpager_enabled",
          },
          {
            "navbar_dotpager_always",
            "simpleui_bar_dotpager_always",
          },
          ...
          {
            "navbar_bottombar_settings_on_hold",
            "simpleui_bar_settings_on_hold",
          },
          -- Top bar
          {
            "navbar_topbar_enabled",
            "simpleui_topbar_enabled",
          },
          {
          ...
          {
            "navbar_topbar_custom_text",
            "simpleui_topbar_custom_text",
          },
          {
            "navbar_topbar_settings_on_hold",
            "simpleui_topbar_settings_on_hold",
          },
          {
            "navbar_topbar_swipe_indicator",
            "simpleui_topbar_swipe_indicator",
          },
          {
            "navbar_topbar_wifi_hide_when_off",
            "simpleui_topbar_wifi_hide_when_off",
          },
          {
            "navbar_topbar_size_pct",
            "simpleui_topbar_size_pct",
          },
          -- Homescreen bar — fixed keys
          {
            "navbar_homescreen_pagination_hidden",
            "simpleui_hs_pagination_hidden",
          },
          {
            "navbar_homescreen_settings_on_hold",
            "simpleui_hs_settings_on_hold",
          },
          {
            "navbar_homescreen_overflow_warn",
            "simpleui_hs_overflow_warn",
          },
          {
            "navbar_hs_return_to_book_folder",
            "simpleui_hs_return_to_book_folder",
          },
          {
            "navbar_homescreen_module_scale",
            "simpleui_hs_module_scale",
          },
          {
            "navbar_homescreen_label_scale",
            "simpleui_hs_label_scale",
          },
          {
            "navbar_homescreen_scale_linked",
            "simpleui_hs_scale_linked",
          },
          -- Reading goal
          {
            "navbar_reading_goal",
            "simpleui_reading_goal",
          },
          {
            "navbar_reading_goal_physical",
            "simpleui_reading_goal_physical",
          },
          {
            "navbar_daily_reading_goal_secs",
            "simpleui_daily_reading_goal_secs",
          },
          -- Reading goals module display
          {
            "navbar_reading_goals_show_annual",
            "simpleui_reading_goals_show_annual",
          },
          {
            "navbar_reading_goals_show_daily",
            "simpleui_reading_goals_show_daily",
          },
          {
            "navbar_reading_goals_layout",
            "simpleui_reading_goals_layout",
          },
          -- Collections module
          {
            "navbar_collections_list",
            "simpleui_collections_list",
          },
          {
            "navbar_collections_covers",
            "simpleui_collections_covers",
          },
          {
            "navbar_collections_badge_position",
            "simpleui_collections_badge_position",
          },
          {
            "navbar_collections_badge_color",
            "simpleui_collections_badge_color",
          },
          {
            "navbar_collections_badge_hidden",
            "simpleui_collections_badge_hidden",
          },
        ...
        SUISettings:flush()
        logger.info(
          "simpleui: settings migration v3 complete —",
          migrated,
          "navbar_* keys renamed to simpleui_*"
        )
      end)
    ...
    if not SUISettings:isTrue("simpleui_settings_migrated_v4") then
      pcall(function()
        local icon_renames = {
          {
            "simpleui_sysicon_bm_normal",
            "simpleui_sysicon_sui_browse_normal",
          },
          {
            "simpleui_sysicon_bm_author",
            "simpleui_sysicon_sui_browse_author",
          },
          {
            "simpleui_sysicon_bm_series",
            "simpleui_sysicon_sui_browse_series",
          },
          {
            "simpleui_sysicon_bm_tags",
            "simpleui_sysicon_sui_browse_tags",
          },
          {
            "simpleui_sysicon_pg_chev_left",
            "simpleui_sysicon_sui_pager_prev",
          },
          {
            "simpleui_sysicon_pg_chev_right",
            "simpleui_sysicon_sui_pager_next",
          },
          {
            "simpleui_sysicon_pg_chev_first",
            "simpleui_sysicon_sui_pager_first",
          },
          {
            "simpleui_sysicon_pg_chev_last",
            "simpleui_sysicon_sui_pager_last",
          },
          {
            "simpleui_sysicon_coll_back",
            "simpleui_sysicon_sui_coll_back",
          },
        }
        local migrated = 0
        ...
        if type(icon_presets) == "table" then
          ...
          if changed then
            SUISettings:set("simpleui_icon_presets", icon_presets)
          end
        end
        SUISettings:flush()
        logger.info(
          "simpleui: settings migration v4 complete —",
          migrated,
          "icon keys renamed"
        )
      end)
      ...
      pcall(function()
        ...
        local function map_cfg(cfg_key, mapping)
          ...
          if type(cfg) == "table" then
            ...
            if type(cfg.order_left) == "table" then
              map_arr(cfg.order_left)
            end
            if type(cfg.order_right) == "table" then
              map_arr(cfg.order_right)
            end
            if changed then
        ...
        logger.info(
          "simpleui: settings migration v5 complete —",
          migrated,
          "titlebar keys renamed"
        )
      end)
    ...
    if not SUISettings:isTrue("simpleui_settings_migrated_v6") then
      pcall(function()
        ...
        for k, _ in SUISettings:iterateKeys() do
          if type(k) == "string" then
            for _, mod_id in ipairs(bare_mods) do
              ...
              if
                klen > slen
                and k:sub(klen - slen + 1) == sfx
                and k:sub(klen - slen) == "_"
              then
        ...
        local coll_renames = {
          ...
          {
            "simpleui_collections_covers",
            "simpleui_coll_covers",
          },
          {
            "simpleui_collections_badge_position",
            "simpleui_coll_badge_position",
          },
          {
            "simpleui_collections_badge_color",
            "simpleui_coll_badge_color",
          },
          {
            "simpleui_collections_badge_hidden",
            "simpleui_coll_badge_hidden",
          },
        }
        ...
        SUISettings:flush()
        logger.info(
          "simpleui: settings migration v6 complete —",
          migrated,
          "keys renamed/removed"
        )
      end)
    ...
    if not SUISettings:isTrue("simpleui_settings_migrated_v7") then
      pcall(function()
        ...
        then
          ...
          logger.info(
            "simpleui: migration v7 — restored coverdeck_show_title to true"
          )
        end
        ...
        if SUISettings:get("simpleui_updater_auto_check") == nil then
          ...
          logger.info(
            "simpleui: migration v7 — enabled simpleui_updater_auto_check"
          )
        end
      end)
    ...
    if SUISettings:nilOrTrue("simpleui_enabled") then
      ...
      UIManager:scheduleIn(0, function()
        ...
        if not (ok_fm and FM and FM.instance) then
          return
        end
        local ok_tbr, TBR = pcall(require, "desktop_modules/module_tbr")
        if not (ok_tbr and TBR) then
          return
        end
        ...
        FM.instance:addFileDialogButtons(
          "sui_tbr",
        ...
        local ok_fs, FS =
          pcall(require, "apps/filemanager/filemanagerfilesearcher")
        if ok_fs and FS and not FS._sui_onMenuHold_patched then
          ...
          FS.file_dialog_added_buttons = FS.file_dialog_added_buttons
            or { index = {} }
      ...
      UIManager:scheduleIn(0, function()
        ...
        if not (ok_fm2 and FM2 and FM2.instance) then
          return
        end
        ...
        local function _makeAuthorRow(file, is_file, book_props, close_cb)
          ...
          if not authors_raw or authors_raw == "" then
            return nil
          end
          ...
          return {
            {
              ...
              callback = function()
                ...
                if fm2 then
                  BM.navigateToAuthorLeaf(fm2, author, file)
                end
              end,
            },
          }
        ...
        -- 1. Library browser (FileManager.showFileDialog).
        FM2.instance:addFileDialogButtons(
          "sui_browse_author",
          function(file, is_file, book_props)
        ...
        if ok_fs2 and FS2 then
          FS2.file_dialog_added_buttons = FS2.file_dialog_added_buttons
            or { index = {} }
          if
            FS2.file_dialog_added_buttons.index["sui_browse_author"] == nil
          then
            local row_func = function(file, is_file, book_props, close_cb)
      ...
      UIManager:scheduleIn(0, function()
        ...
        if not (ok_fm3 and FM3 and FM3.instance) then
          return
        end
          ...
          return {
            {
              ...
              callback = function()
                ...
                if ok_sw and SW then
                  if SW.showLoadingNotice then
                    SW.showLoadingNotice()
                  end
        ...
        -- 1. Library browser (FileManager.showFileDialog).
        FM3.instance:addFileDialogButtons(
          "sui_book_stats",
          function(file, is_file, book_props)
            local close_cb = function()
        ...
        if ok_fs3 and FS3 then
          FS3.file_dialog_added_buttons = FS3.file_dialog_added_buttons
            or { index = {} }
...
function SimpleUIPlugin:onTeardown()
  ...
  if FM and FM.instance and FM.instance.removeFileDialogButtons then
    pcall(function()
      FM.instance:removeFileDialogButtons("sui_tbr")
    end)
  end
  ...
  if FM and FM.instance and FM.instance.removeFileDialogButtons then
    pcall(function()
      FM.instance:removeFileDialogButtons("sui_browse_author")
    end)
  end
  ...
  if FM and FM.instance and FM.instance.removeFileDialogButtons then
    pcall(function()
      FM.instance:removeFileDialogButtons("sui_book_stats")
    end)
  end
  if FS and FS.file_dialog_added_buttons then
    local idx = FS.file_dialog_added_buttons.index
...
function SimpleUIPlugin:onScreenResize()
  if self._simpleui_suspended then
    return
  end
  ...
  UIManager:scheduleIn(0.2, function()
    ...
    if HS and HS._instance then
      ...
      if not self._goalTapCallback then
        self:addToMainMenu({})
      end
      local tabs = Config.loadTabConfig()
      Bottombar.setActiveAndRefreshFM(self, "homescreen", tabs)
      HS.show(function(aid)
        self:_navigate(aid, self.ui, Config.loadTabConfig(), false)
      end, self._goalTapCallback)
      return
    end
...
function SimpleUIPlugin:onCloseDocument()
  ...
  do
    ...
    if not notice_mode then
      notice_mode = SUISettings:nilOrTrue("simpleui_hs_closing_notice")
          and "always"
        or "never"
    end
    ...
    if
      (notice_mode == "always" and not suppress)
      or (notice_mode == "gesture_only" and via_gesture)
    then
    ...
    if SP then
      ...
      if closed_fp and SP.invalidateTimeSeries then
        ...
        if
          RUI
          and RUI.instance
          and type(RUI.instance.doc_settings) == "table"
        then
  ...
  if currently_active then
    ...
    if MC and MC.invalidateCache then
      MC.invalidateCache()
    end
    needs_refresh = true
  end
...
function SimpleUIPlugin:onFrontlightStateChanged()
  ...
  if not SUISettings:nilOrTrue("simpleui_topbar_enabled") then
    return
  end
  Topbar.scheduleRefresh(self, 0)
end
...
function SimpleUIPlugin:_scheduleRebuild()
  if self._rebuild_scheduled then
    return
  end
...
function SimpleUIPlugin:addToMainMenu(menu_items)
  ...
  if not _menu_installer then
    ...
    if not ok then
      ...
      menu_items.simpleui =
        { sorting_hint = "tools", text = _("Simple UI"), sub_item_table = {} }
      return
    end
