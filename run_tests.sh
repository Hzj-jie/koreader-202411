...
cleanup() {
    ...
    rm -rf cache/ defaults.defaults_spec.lua docsettings/ docsettingspec/ dummy-test-file* file.sdr/ help/ history.lua ota/ readerbookmark.pdf readerbookmark.sdr/ readerhighlight.pdf readerhighlight.sdr/ readerhighlight_pdf.pdf readerhighlight_pdf.sdr/ readerhighlight_epub.epub readerhighlight_epub.sdr/ screenshots/ settings/ styletweaks/ testdata/ this-is-not-a-valid-file*
}
