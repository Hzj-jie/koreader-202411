...
describe("Blitbuffer unit tests", function()
  ...
  describe("basic BB API", function()
    ...
    it("should do color comparison correctly", function()
      ...
      assert.True(Blitbuffer.ColorRGB24(128, 125, 123) == Blitbuffer.ColorRGB24(128, 125, 123))
      assert.True(Blitbuffer.ColorRGB32(128, 120, 123, 1) == Blitbuffer.ColorRGB32(128, 120, 123, 1))
    end)

    it("should do color comparison with conversion correctly", function()
      assert.True(Blitbuffer.Color8(127) == Blitbuffer.ColorRGB24(127, 127, 127))
      assert.True(Blitbuffer.Color8A(127, 100) == Blitbuffer.ColorRGB32(127, 127, 127, 100))
    end)
