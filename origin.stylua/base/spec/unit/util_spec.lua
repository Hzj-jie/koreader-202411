...
describe("util module", function()
  ...
  describe("util.template", function()
    ...
    it("should replace place markers with arguments", function()
      ...
      local str_template =
        util.template("The arguments go %1 and %2.", "here", "there")
      assert.are.equal(str_regular, str_template)
    end)
    ...
    it("should allow dynamic positioning of place markers", function()
      ...
      local str_template =
        util.template("The arguments go %2 and %1.", "here", "there")
      assert.are.equal(str_regular, str_template)
    end)

    it(
      "should replace place markers no matter how many times they appear",
      function()
    ...
    it("should not allow escaping", function()
      ...
      local str_template =
        util.template("This %%1 tried to escape.", "argument")
      assert.are.equal(str_regular, str_template)
    end)
  end)
