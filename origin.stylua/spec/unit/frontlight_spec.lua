describe("Frontlight function in PowerD", function()
  ...
  it(
    "should turn on and off frontlight when the minimum level is 1 and frontlight was off",
    function()
      test_when_off(1)
    end
  )
  ...
  it(
    "should turn on and off frontlight when the minimum level is 1 and frontlight was on",
    function()
      test_when_on(1)
    end
  )
