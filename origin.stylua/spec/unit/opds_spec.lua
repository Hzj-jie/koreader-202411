...
describe("OPDS module #nocov", function()
  ...
  describe("OPDS browser module", function()
    describe("URL generation", function()
      ...
      it(
        "should use the main URL for faceted links as long as faceted links aren't properly supported #internet",
        function()
    ...
    it(
      "should not fill item table incorrectly with thumbnail or image URL #internet",
      function()
        local catalog = OPDSParser:parse(facet_sample)
        local item_table = OPDSBrowser:genItemTableFromCatalog(
          catalog,
