describe("DepGraph module", function()
  ...
  it("should serialize complex graph2", function()
    ...
    dg:addNode(
      "tap_backward",
      { "readerfooter_tap", "readermenu_tap", "readerhighlight_tap" }
    )
    dg:addNode(
      "tap_forward",
      { "readerfooter_tap", "readermenu_tap", "readerhighlight_tap" }
  ...
  it(
    "should serialize complex graph and keep dependencies after removing and re-adding",
    function()
      local dg = DepGraph:new({})
