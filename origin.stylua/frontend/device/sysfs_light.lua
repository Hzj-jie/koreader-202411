...
dbg:guard(SysfsLight, "setBrightness", function(self, brightness)
...
dbg:guard(SysfsLight, "setWarmth", function(self, warmth)
  assert(warmth >= 0 and warmth <= 100, "Wrong warmth value given!")
end)
