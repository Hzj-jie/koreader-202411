...
function ReaderFooter:init()
  ...
  self.custom_text_repetitions = tonumber(G_reader_settings:readSetting("reader_footer_custom_text_repetitions", "1"))
end
        ...
        },
        {
          ...
          callback = function()
            ...
            if self.custom_text ~= new_text then
              ...
              G_reader_settings:saveSetting("reader_footer_custom_text", self.custom_text)
            end
            ...
            if new_repetitions and self.custom_text_repetitions ~= new_repetitions then
              ...
              G_reader_settings:saveSetting("reader_footer_custom_text_repetitions", self.custom_text_repetitions)
            end
            UIManager:close(text_dialog)
